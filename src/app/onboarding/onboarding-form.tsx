...
import { AFRICAN_COUNTRIES, type Country } from "@/lib/data/african-countries";
...
const initialState: CreateOrganisationActionState = undefined;
    ...
    <form action={action} className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="space-y-2">
          ...
          <Select name="organisationType" items={organisationTypeOptions}>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1 space-y-1 pt-1">
            ...
            <p className="text-xs text-muted-foreground">
              PNG or JPG. Shown on team cards and in your workspace.
            </p>
          </div>
        </div>
        <input
      ...
      <div className="space-y-2">
        <Label htmlFor="referralSource">
          How did you hear about Nia? (optional)
        </Label>
        <Select name="referralSource" items={referralSourceOptions}>
        ...
        {state?.fieldErrors?.referralSource && (
          <p className="text-sm text-destructive">
            {state.fieldErrors.referralSource[0]}
          </p>
        )}
      </div>
